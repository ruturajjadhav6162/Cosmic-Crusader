...
public class GameMenu extends State implements StateMethods{
    ...
    private void loadButtons() {
        buttons[0]=new MenuButton((int) (500*SCALE), (int) (222.222*SCALE),0,GameState.PLAYING);
...
//        g.setColor(Color.BLUE);
        ...
        g.drawImage(HomeScreen2,(int)(420.77*SCALE),(int)(23.333*SCALE),(int)(300.444*SCALE),(int)(180*SCALE),null);
        for (MenuButton mb : buttons){
            mb.drawButtons(g);
        }
    }
